...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('Assets/Ample/plugins/images/favicon.png')}}">
    <!-- Custom CSS -->
    <link href="{{asset('Assets/Ample/plugins/bower_components/chartist/dist/chartist.min.css')}}" rel="stylesheet">
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.html">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="{{asset('Assets/Ample/plugins/images/logo-icon.png')}}" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{asset('Assets/Ample/plugins/images/logo-text.png')}}" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="{{asset('Assets/Ample/plugins/images/users/varun.jpg')}}" alt="user-img" width="36"
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('Assets/Ample/plugins/bower_components/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{asset('Assets/Ample/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('Assets/Ample/js/app-style-switcher.js')}}"></script>
    <script src="{{asset('Assets/Ample/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('Assets/Ample/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('Assets/Ample/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('Assets/Ample/js/custom.js')}}"></script>
